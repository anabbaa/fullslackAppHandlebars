...
//     const user = await new User.findOne (req.body.username);
//     // its more security
//     console.log(user);
//     if (user == null) {
//       return res
...
//         let sessionId = uuid();
//         res.cookie("session_id", sessionId, {//cookie name name value pptions
// expires: new Date(Date.now() + 900000),
//         });
//         res.cookie("role", user.role, {
//           expires: new Date(Date.now() + 900000), //cookie will expires in 15 min
//           //first get time then add in miliseconds
//         });
...
//           uuid: sessionId,
//           user_id: user,
//           // mongoose will know grab the userid injected in session
//         });
//         session.save();
